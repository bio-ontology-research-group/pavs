...
OMIM_HPOA_PATH = "data/phenotype.hpoa"
MIM2GENE_PATH = "data/mim2gene.txt"
GFF_PATH = "data/GCF_000001405.40_GRCh38.p14_genomic.gff"
...
class NormalizationUtils:
    ...
    def enable_graph_rag(self):
        try:
            from scripts.graph_rag_normalization import GraphRAG
