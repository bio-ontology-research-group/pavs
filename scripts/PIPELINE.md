...
|------|--------------|------|-------|
| `ahmed-variants.tsv` | A | 291 | HPOs, Gene, Variant, Protein, Zygosity, ACMG Classification |
| `ahmed-pmid28454995.tsv` | B | 234 | Variant 1 Gene, c.DNA, g.DNA (GRCh38) |
...
Full documentation: `tools/phenotype_matcher_v2/README.md`
